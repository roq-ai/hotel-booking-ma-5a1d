...
export const HelpBox: React.FC = () => {
  ...
  const tenantRoles: string[] = ['Hotel Manager', 'Front Desk Staff', 'Booking Agent', 'Housemaid Staff'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `Hotel Booking Management Application`;
  const tenantName = `Hotel`;
